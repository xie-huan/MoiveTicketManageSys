...
public class PlayInfoAddFrame extends JFrame {
	...
	public PlayInfoAddFrame() {
		...
		selectMoive.setFont(new Font("微软雅黑", Font.PLAIN, 13));
		...
		selectHall.setFont(new Font("微软雅黑", Font.PLAIN, 13));
		...
		price.setFont(new Font("微软雅黑", Font.PLAIN, 13));
		...
		start_time.setFont(new Font("微软雅黑", Font.PLAIN, 13));
		...
		confirm.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (i == 1) {
					...
					// 添加成功后为此场次建立一张座位表
					int schedule_id = Dao.selectScheduleIDByInfo(moive_id, hall_id, set_price, time);
		...
		lblNewLabel_2.setBounds(0, 0, 347, 271);
		lblNewLabel_2.setIcon(new ImageIcon("img/planet1.jpg"));
